...
| S02 | Cursor-based pagination with next/prev URLs | high | S01 | ⬜ | GET /api/v1/jobs?count=5 returns page with next/prev URLs; following next returns the next stable page; inserting jobs between page fetches doesn't shift results |
