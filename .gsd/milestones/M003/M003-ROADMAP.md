...
| S03 | S03 | low | — | ⬜ | DELETE /api/v1/jobs/:id returns 204 for completed job, 404 for missing, 409 for in_process; full integration test suite covers filters, pagination, and delete |
