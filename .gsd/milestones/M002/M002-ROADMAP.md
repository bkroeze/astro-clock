...
| S02 | Test database infrastructure | medium | S01 | ⬜ | just test-db-setup creates a seeded test DB; a test binary can connect, query planet_positions, and assert known values |
