...
plan: 03
subsystem: database
tags: [swiss-ephemeris, chunk-generation, batch-inserts, sqlx, rust]
...
affects:
  - 02-04 (background pre-fetching will use ChunkGenerator)
  - Query system (will use generated chunks)

tech-stack:
  added: []
  patterns:
    - "UNNEST batch inserts for PostgreSQL performance"
    - "Fire-and-forget background tasks with tokio::spawn"
    - "Three-tier fallback: cache → database → generation"
