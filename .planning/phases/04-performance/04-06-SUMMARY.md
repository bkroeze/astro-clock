...
tags: [rust, aspects, filtering, storage-optimization]

# Dependency graph
requires:
  - phase: 04-performance
    provides: "calculate_aspects() function and is_major_aspect() helper"
provides:
...
tech-stack:
  added: []
  patterns:
    - "Inline constants to avoid dead code warnings"
    - "Early continue pattern for filtering"
