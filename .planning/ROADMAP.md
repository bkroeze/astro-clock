...
- [x] 06-01-PLAN.md — LoadJobHandler implementation (LOAD-08, LOAD-09, LOAD-10)
- [x] 06-02-PLAN.md — CLI load command integration (LOAD-06)
- [x] 06-03-PLAN.md — API endpoints and job status (LOAD-07, RESULT-03, RESULT-04)
