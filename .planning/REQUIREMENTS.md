...
- [x] **API-01**: Endpoint `POST /api/v1/query/wedding` with `{start_date, days, sync?}`
- [x] **API-02**: Endpoint `POST /api/v1/query/project` with `{start_date, days, sync?}`
- [x] **API-03**: Endpoint `POST /api/v1/query/travel` with `{start_date, days, sync?}`
